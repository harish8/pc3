...
<h1>Pc3 - Personal computer cost and config Details</h1>
  <p>
    Its just a simple web application purely written in php. This application basically concentrated on the <b><i><u>crud functionality</u></i></b> saving and retrieving  all the information using database.  
  </p>
<?php
//	require 'db.php';
//	try {
...
//
	...
	echo "<td>{$warranty}</td>";
	echo "<td class='col-sm-2'><a href='view.php?id={$laptop_id}'>View</a> /  <a href = 'edit.php?id={$laptop_id}'>Edit</a> /<a href='delete.php?id={$laptop_id}'>Delete</a> </td>";
	echo "</tr>";
	echo "</tbody>";
	}
	} catch(PDOException $e) {
